...
const List = () => {
 ...
 useEffect(() => {
  async function getAllStudent() {
   try {
    const students = await axios.get("https://639363d8ab513e12c50d02a6.mockapi.io/studentdata/")
 ...
 const handleDelete = async id => {
  await axios.delete(`https://639363d8ab513e12c50d02a6.mockapi.io/studentdata/${id}`);
